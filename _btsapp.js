...
/*
This is a modified version of the store_search extension, which uses native elastic searches instead of legacy.
*/
...
////////////////////////////////////   UTIL    \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
		...
		renderFormats : {
//not used for search, but added to his app cuz it was needed. 
			bannerText : function($tag, data)	{
				myControl.util.dump("BEGIN btsapp(store_search).renderFormats.bannerText");
